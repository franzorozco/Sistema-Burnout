            ...
            <div class="w-full sm:max-w-lg mt-6 mb-6 px-8 py-10 bg-white shadow-2xl overflow-hidden rounded-2xl">
                ...
                <div class="flex justify-center mb-8">
                    <a href="/">
                        {{-- Asegúrate de que esta ruta sea correcta.
                             Coloca tu logo en /public/img/image_484b64.jpg --}}
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="block mt-2 w-full border-gray-300 focus:border-purple-500 focus:ring-purple-500 rounded-lg shadow-sm" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        @if (Route::has('password.request'))
                            <a class="underline text-sm text-purple-600 hover:text-purple-800 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition duration-150 ease-in-out" href="{{ route('password.request') }}">
                    ...
                    <div class="mt-10">
                        {{-- Reemplazamos x-primary-button por un botón personalizado para el degradado --}}
                    ...
                    @if (Route::has('register'))
                        <p class="text-center text-sm text-gray-600 mt-8">
                            ...
                            <a href="{{ route('register') }}" class="font-medium text-purple-600 hover:text-purple-800 underline transition duration-150 ease-in-out">
                                Regístrate aquí
                            </a>
                        </p>
                    @endif
