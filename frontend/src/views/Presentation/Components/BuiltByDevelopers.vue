      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 ms-lg-5">
            <h4 class="text-white">Explora</h4>
            <h1 class="text-white">Reportes científicos</h1>
            <p class="lead text-white opacity-8">
              Accede a una colección de artículos y recursos informativos sobre
              salud mental, bienestar emocional y estrategias para manejar el
              estrés, ansiedad y más.
            </p>
            <a
